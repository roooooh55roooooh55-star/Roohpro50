      ...
      {trendVideos.length > 0 ? (
        <div className="grid grid-cols-2 gap-4 px-2">
            ...
            return (
                ...
                >
                <div className={`relative rounded-3xl overflow-hidden border border-white/5 bg-neutral-900 ${video.video_type === 'Shorts' ? 'aspect-[9/16]' : 'aspect-video'} border-red-600/50 shadow-[0_0_15px_rgba(220,38,38,0.3)]`}>
                    <video 
                    src={video.video_url} 
                    ...
                    <div className="absolute top-3 left-3 bg-red-600 text-[8px] font-black text-white px-2 py-0.5 rounded shadow-[0_0_10px_red] animate-pulse z-20 border border-white/20">
                        TREND #{idx + 1}
                    </div>
